      ...
      <main className="flex-grow container mx-auto px-4 py-6">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-lg">후원금은 어떻게 사용되나요?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  후원금은 서버 유지 비용, 개발자 지원, 콘텐츠 확장, 새로운 기능 개발 등 Webel 플랫폼 개선에 사용됩니다. 
                  저희는 분기별로 후원금 사용 내역을 투명하게 공개하고 있습니다.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-lg">후원은 언제든지 취소할 수 있나요?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  네, 언제든지 마이페이지에서 후원을 취소하실 수 있습니다. 취소 시점 이후의 결제는 진행되지 않습니다. 
                  다만, 이미 결제된 후원금은 환불되지 않습니다.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-lg">후원 등급은 변경할 수 있나요?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  네, 언제든지 마이페이지에서 후원 등급을 변경하실 수 있습니다. 
                  등급 상향 시에는 즉시 적용되며, 하향 시에는 다음 결제일부터 적용됩니다.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-lg">법인/단체 후원도 가능한가요?</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-gray-600">
                  네, 법인이나 단체 후원을 원하시면 support@webel.com으로 문의해주세요. 
                  맞춤형 후원 패키지와 함께 세금계산서 발행 등의 서비스를 제공해드립니다.
                </p>
              </CardContent>
            </Card>
          </div>
