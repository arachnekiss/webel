...
export const translations: Record<Language, any> = {
  ko: {
    ...
    registerService: {
      ...
      serviceInfo: '서비스 정보',
      serviceInfoDesc: '귀하의 서비스 정보와 조건을 입력해주세요',
      selectServiceType: '서비스 유형 선택',
      serviceImage: '서비스 대표 이미지',
      uploadImageText: '클릭하여 이미지 업로드',
      imageRequirements: 'PNG, JPG, GIF (최대 5MB)',
      removeImage: '제거',
      preview: '미리보기',
      serviceTitle: '서비스 제목',
      serviceTitlePlaceholder3D: '예: 강남 프로페셔널 3D 프린팅 서비스',
      serviceTitlePlaceholderEng: '예: 전자회로 설계 및 PCB 제작 서비스',
      titleSearchTip: '지역명과 특징을 포함하면 검색에 유리합니다',
      serviceDescription: '서비스 설명',
      serviceDescPlaceholder: '제공하는 서비스, 특장점, 재료 등에 대해 상세히 작성해주세요',
      printerModel: '3D 프린터 모델',
      printerModelPlaceholder: '예: Prusa i3 MK3S+',
      printerModelDesc: '사용 중인 3D 프린터 모델명을 입력해주세요 (선택사항)',
      fileFormats: '지원 파일 형식',
      materials: '사용 가능한 재료',
      otherMaterials: '기타 재료를 입력해주세요',
      sampleImages: '결과물 샘플 이미지',
      addSample: '추가',
      sample: '샘플',
      specialization: '전문 분야',
      otherSpecialization: '기타 분야를 입력해주세요',
      experience: '경력',
      years: '년',
      portfolio: '포트폴리오 URL',
      portfolioPlaceholder: '예: https://yourportfolio.com',
      hourlyRate: '시간당 요금',
      hourlyRatePlaceholder: '예: 50000',
      availableItems: '취급 가능 품목',
      otherItems: '기타 품목을 입력해주세요',
      contactInfo: '연락처 정보',
      nickname: '닉네임',
      phone: '연락처',
  ...
  en: {
    ...
    registerService: {
      ...
      serviceInfoDesc: 'Please enter your service information and conditions',
      selectServiceType: 'Select Service Type',
      serviceImage: 'Service Image',
      uploadImageText: 'Click to upload image',
      imageRequirements: 'PNG, JPG, GIF (Max 5MB)',
      removeImage: 'Remove',
      preview: 'Preview',
      serviceTitle: 'Service Title',
      serviceTitlePlaceholder3D: 'E.g., Professional 3D Printing Service in New York',
      serviceTitlePlaceholderEng: 'E.g., Electronic Circuit Design and PCB Manufacturing Service',
      titleSearchTip: 'Including location and features improves search results',
      serviceDescription: 'Service Description',
      serviceDescPlaceholder: 'Describe your service, its features, materials used, etc. in detail',
      printerModel: '3D Printer Model',
      printerModelPlaceholder: 'E.g., Prusa i3 MK3S+',
      printerModelDesc: 'Enter the 3D printer model you are using (optional)',
      fileFormats: 'Supported File Formats',
      materials: 'Available Materials',
      otherMaterials: 'Enter other materials',
      sampleImages: 'Sample Images',
      addSample: 'Add',
      sample: 'Sample',
      specialization: 'Specialization',
      otherSpecialization: 'Enter other specialization',
      experience: 'Experience',
      years: 'years',
      portfolio: 'Portfolio URL',
      portfolioPlaceholder: 'E.g., https://yourportfolio.com',
      hourlyRate: 'Hourly Rate',
      hourlyRatePlaceholder: 'E.g., 50',
      availableItems: 'Available Items',
      otherItems: 'Enter other items',
    ...
    features: {
      ...
      remoteSupport: {
        ...
        textVoiceDesc: 'In the channel list, # indicates text channels, and 🔊 indicates voice channels.',
        screen: 'Share Screen',
        ...
        copyright: '© 2025 Webel. All rights reserved.'
      }
    },
  ...
  jp: {
    ...
    features: {
      ...
      remoteSupport: {
        title: '専門家によるリモート組立サポート',
        description: '難しいハードウェアの組立や複雑な設定プロセスをリアルタイムのリモートサポートで解決します。いつでもどこでもプロのエンジニアからの支援を受けられます。',
        joinDiscord: 'Discordに参加',
        discordFeatures: 'Discordコミュニティの特徴',
        voiceVideo: '音声・ビデオチャンネル',
        voiceVideoDesc: 'Discordの音声・ビデオチャンネルを通じて専門家とリアルタイムでコミュニケーションを取り、問題解決に必要な支援を受けられます。',
        openCommunity: 'オープンコミュニティ',
        openCommunityDesc: '様々な分野の専門家と支援を必要とするユーザーが集まり、知識を自由に共有したりDIY成果を披露したりするオープンな場です。',
        infoSharing: '情報・リソース共有',
        infoSharingDesc: 'Webelリソースと連携した様々な情報、設計図、ドキュメントなどを共有し、他のユーザーのノウハウを学ぶことができます。',
        discordGuide: 'Discordサーバーガイド',
        webelDiscord: 'Webel Discordコミュニティ',
        discordDesc: 'ハードウェアの組立、3Dプリント、ソフトウェア設定など様々なトピックについてリアルタイムで助け合えるWebelコミュニティにご招待します。',
        freeCommunity: '自由に交流するコミュニティ',
        textVoiceChannels: 'テキスト・音声チャンネル',
        screenSharing: '画面共有機能',
        joinServer: 'Discordサーバーに参加',
        howToUse: 'Discordの使い方',
        server: 'サーバーに参加',
        serverDesc: 'Discordアカウントでウェベルサーバーに参加してください。',
        channel: 'チャンネル選択',
        channelDesc: '左側のサイドバーからトピック別のチャンネルを選択してください。',
        textVoice: 'テキスト/音声チャンネルを利用',
        textVoiceDesc: 'チャンネル一覧で、#はテキストチャンネル、🔊は音声チャンネルを示します。',
        screen: '画面共有',
        screenDesc: '音声チャンネルに参加後、画面共有ボタンを押してリアルタイムで支援を受けましょう。',
        engineers: '自発的なエンジニア参加',
        engineersDesc: 'エンジニアリングの知識はありますか？困っているユーザーに自発的に支援を提供しましょう。誰でも自由に知識を共有し、支援できます。',
        channels: '主要チャンネル案内',
        announcements: 'お知らせ',
        announcementsDesc: 'Webelコミュニティのお知らせとアップデート情報',
        introductions: '自己紹介',
        introductionsDesc: 'コミュニティメンバーの自己紹介チャンネル',
        qa: '質問・回答',
        qaDesc: '様々なトピックに関する質問と回答',
        voice: '音声チャンネル',
        voiceDesc: 'リアルタイム音声チャットと画面共有',
        benefits: 'Discordコミュニティの特典',
        knowledgeSharing: 'ユーザー間の知識共有',
        knowledgeSharingDesc: '他のDIY制作者と知識と経験を共有して問題を解決しましょう',
        realtime: 'リアルタイム問題解決',
        realtimeDesc: '組立過程で発生した問題をリアルタイムで支援を受けられます',
        projectSharing: 'リソースとプロジェクト共有',
        projectSharingDesc: '完成したプロジェクトや有用なリソースをコミュニティと共有できます',
        copyright: '© 2025 Webel. 全著作権所有。'
      }
    },
    ...
    registerService: {
      ...
      serviceInfo: 'サービス情報',
      serviceInfoDesc: 'サービス情報と条件を入力してください',
      selectServiceType: 'サービスタイプを選択',
      serviceImage: 'サービス画像',
      uploadImageText: 'クリックして画像をアップロード',
      imageRequirements: 'PNG、JPG、GIF（最大5MB）',
      removeImage: '削除',
      preview: 'プレビュー',
      serviceTitle: 'サービスタイトル',
      serviceTitlePlaceholder3D: '例：東京プロフェッショナル3Dプリントサービス',
      serviceTitlePlaceholderEng: '例：電子回路設計とPCB製造サービス',
      titleSearchTip: '地域名と特徴を含めると検索結果が向上します',
      serviceDescription: 'サービス説明',
      serviceDescPlaceholder: '提供するサービス、特徴、使用材料などを詳しく説明してください',
      printerModel: '3Dプリンターモデル',
      printerModelPlaceholder: '例：Prusa i3 MK3S+',
      printerModelDesc: '使用中の3Dプリンターモデル名を入力してください（任意）',
      fileFormats: '対応ファイル形式',
      materials: '利用可能な材料',
      otherMaterials: 'その他の材料を入力してください',
      sampleImages: 'サンプル画像',
      addSample: '追加',
      sample: 'サンプル',
      specialization: '専門分野',
      otherSpecialization: 'その他の分野を入力してください',
      experience: '経験',
      years: '年',
      portfolio: 'ポートフォリオURL',
      portfolioPlaceholder: '例：https://yourportfolio.com',
      hourlyRate: '時給',
      hourlyRatePlaceholder: '例：5000',
      availableItems: '取り扱い可能な品目',
      otherItems: 'その他の品目を入力してください',
      contactInfo: '連絡先情報',
      nickname: 'ニックネーム',
      phone: '電話番号',
