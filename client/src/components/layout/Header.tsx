      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between py-4">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            <Link href="/login">
              <a className="text-gray-600 hover:text-primary transition-colors">로그인</a>
            </Link>
            <Link href="/register">
              <a className="text-gray-600 hover:text-primary transition-colors">회원가입</a>
            </Link>
            <Link href="/sponsor">
        ...
        {isMobile && isMobileMenuOpen && (
          <nav className="md:hidden py-3 space-y-3">
            <Link href="/login">
              <a className="block px-4 py-2 text-gray-600 hover:bg-gray-100 rounded">로그인</a>
            </Link>
            <Link href="/register">
              <a className="block px-4 py-2 text-gray-600 hover:bg-gray-100 rounded">회원가입</a>
            </Link>
            <Link href="/sponsor">
              <a className="block px-4 py-2 bg-primary text-white rounded">Webel 후원하기</a>
            </Link>
          </nav>
        )}
      </div>
